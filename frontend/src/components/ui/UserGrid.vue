                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="SubscribeExpirationDate">{{ val.subscribeExpirationDate }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Date label="SubscribeExpirationDate" v-model="selectedRow.subscribeExpirationDate" :editMode="true"/>
